...
The infrastructure and the application are both up: the cluster runs Agones, the guardrails, and a live Minecraft server reachable from the internet, and the Discord bot + ops agent (Gary) is deployed and gate-signed via CI.
